...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function companionReply(text) {
        ...
        try {
            ...
            // Read the response from Cloudflare

            const data = await response.json();


            // Show the actual Worker response in the browser console
            ...
            // If Cloudflare/Gemini returned an error,
            ...
            // IMPORTANT:
            // This temporarily shows the real error
            // so we can identify what needs fixing.
